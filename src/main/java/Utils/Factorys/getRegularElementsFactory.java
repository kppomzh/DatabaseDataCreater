...
import dataStructure.RegularClasses.BracketExpression;
...
public class getRegularElementsFactory {
    ...
    private ArrayList<String> regularElements;
    ...
    public boolean checkREle(String element){
        return regularElements.contains(element);
    }

    public Regular makeRegularElement(String element){
        Regular r = null;
        switch (element){
            case "\\d":
            case "\\s":
