...
public class MetaString extends baseTypeCreaterImpl implements Regular {
...
//                    throw new NullMetaStringException(word);
    ...
    public String getString() {
        String res=buildString().insert(0,'\'').append('\'').toString();
        while (!post(res)){
            res=buildString().insert(0,'\'').append('\'').toString();
        }
        return res;
    }
}
